...
class InfoPagesTestCase(unittest.TestCase):
    ...
    def test_change_user_info(self):
        ...
        response = self.client.post(
            ...
            data={"name": "mike", "age": "15", "location": "China", "about_me": "hi"},
            follow_redirects=True,
        )
        self.assertTrue(
    ...
    def test_admin_promote(self):
        ...
        response = self.client.post(
            url_for("auth.login"),
            data={
                "identifier": "admin", "password": "12345678", "remember_me": "False"
            },
            follow_redirects=True,
        )
        ...
        response = self.client.post(
            url_for("main.admin_info_edit", username="test"),
            data={
                "email": "test@test.com", "username": "test", "permission": ["admin"]
            },
            follow_redirects=True,
        )
