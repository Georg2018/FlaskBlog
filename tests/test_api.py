...
class PostApiTestCase(unittest.TestCase):
    ...
    def test_post_put(self):
        ...
        res = self.open_with_auth(
            "api/post", "put", "test", "test", {"title": "test", "body": "test"}
        )
    ...
    def test_post_post(self):
        ...
        res = self.open_with_auth(
            "api/post/" + str(post.id),
            "post",
            "test",
            "test",
            {"title": "put_test", "body": "put_test"},
        )
...
class CommentApiTest(unittest.TestCase):
    ...
    def test_comment_put(self):
        ...
        res = self.open_with_auth(
            "api/post/%d/comments" % (post.id), "put", "test", "test", {"body": "test"}
        )
